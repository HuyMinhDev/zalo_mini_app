  ...
  if (collapsible === 'none') {
    return (
      <aside
        ...
        data-side={side}
        className={cn(
          'flex w-full flex-col bg-sidebar text-sidebar-accent-foreground',
          className
        )}
        {...props}
      >
      ...
      {items.map((item) => {
        ...
        const linkContent = (
          ...
          >
            ...
            <Icon className={cn('h-5 w-5 shrink-0', state === 'collapsed' && 'h-5 w-5', isActive && 'text-sidebar-active')} />
            {state === 'expanded' && (
              <>
          ...
          return (
            <Tooltip key={item.href}>
              ...
              >
                ...
                {item.badge && (
                  <p className="text-xs text-white">Notifications: {item.badge}</p>
                )}
              </TooltipContent>
            </Tooltip>
          );
